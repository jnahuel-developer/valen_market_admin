    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Menu superior
          const CustomTopBar(title: TEXTO__home_screen__titulo),
              ...
              child: Column(
                children: [
                  CustomHomeButton(
                    ...
                    text: TEXTO__home_screen__bloque__clientes,
                    onTap: () =>
                  ...
                  CustomHomeButton(
                    ...
                    text: TEXTO__home_screen__bloque__catalogo,
                    onTap: () =>
                  ...
                  CustomHomeButton(
                    ...
                    text: TEXTO__home_screen__bloque__fichas,
                  ...
                  CustomHomeButton(
                    ...
                    text: TEXTO__home_screen__bloque__recorrido,
                    onTap: () =>
                  ...
                  const CustomHomeButton(
                    ...
                    text: TEXTO__home_screen__bloque__estadisticas,
                  ),
                  const SizedBox(height: 40),
                  const CustomHomeButton(
                    iconPath: AppAssets.iconPromotion,
                    fieldKey: KEY__home_screen__boton__promociones,
                    text: TEXTO__home_screen__bloque__promociones,
                  ),
